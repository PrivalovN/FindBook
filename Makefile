#############################################################################
# Makefile for building: findbooks
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  findbooks.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug -o Makefile findbooks.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_NETWORK_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lQt5Network -L/usr/lib/x86_64-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		downloader.cpp moc_downloader.cpp
OBJECTS       = main.o \
		downloader.o \
		moc_downloader.o
...
Makefile: findbooks.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug -o Makefile findbooks.pro
...
dist: 
	@test -d .tmp/findbooks1.0.0 || mkdir -p .tmp/findbooks1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/findbooks1.0.0/ && $(COPY_FILE) --parents downloader.h .tmp/findbooks1.0.0/ && $(COPY_FILE) --parents main.cpp downloader.cpp .tmp/findbooks1.0.0/ && (cd `dirname .tmp/findbooks1.0.0` && $(TAR) findbooks1.0.0.tar findbooks1.0.0 && $(COMPRESS) findbooks1.0.0.tar) && $(MOVE) `dirname .tmp/findbooks1.0.0`/findbooks1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/findbooks1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_downloader.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_downloader.cpp
moc_downloader.cpp: /usr/include/qt5/QtCore/QObject \
